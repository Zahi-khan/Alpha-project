...
class TransactionView:
    id: str | None; formatted_date: str | None; merchant_name: str | None; fallback_description: str; category_name: str | None; industry_name: str | None; payment_name: str | None; amount: Any; formatted_amount: str; direction: str; confidence_label: str; warning_flags: tuple[str, ...] = (); review_required: bool = False
